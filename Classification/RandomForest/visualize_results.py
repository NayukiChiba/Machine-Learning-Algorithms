...
RF_OUTPUTS = os.path.join(OUTPUTS_ROOT, "RandomForest")
...
def visualize_results(
    ...
    plt.tight_layout()
    filepath = os.path.join(RF_OUTPUTS, "04_confusion_matrix.png")
    ...
    plt.tight_layout()
    filepath = os.path.join(RF_OUTPUTS, "05_decision_boundary.png")
    plt.savefig(filepath, dpi=300, bbox_inches="tight")
    print(f"保存图像: {filepath}")
    ...
    plt.tight_layout()
    filepath = os.path.join(RF_OUTPUTS, "06_feature_importance.png")
    plt.savefig(filepath, dpi=300, bbox_inches="tight")
    print(f"保存图像: {filepath}")
