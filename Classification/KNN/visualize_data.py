...
def visualize_data(data: DataFrame):
    ...
    plt.tight_layout()
    filepath = os.path.join(KNN_OUTPUTS, "01_class_distribution.png")
    ...
    plt.tight_layout()
    filepath = os.path.join(KNN_OUTPUTS, "02_data_scatter.png")
    plt.savefig(filepath, dpi=300, bbox_inches="tight")
    print(f"保存图像: {filepath}")
    ...
    plt.tight_layout()
    filepath = os.path.join(KNN_OUTPUTS, "03_correlation_heatmap.png")
    plt.savefig(filepath, dpi=300, bbox_inches="tight")
    print(f"保存图像: {filepath}")
