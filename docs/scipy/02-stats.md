...
- 68-95-99.7规则: 约68%在±1σ内，95%在±1.96σ内，99.7%在±3σ内
...
**输出示例**:
```
IQ>130的概率: 0.022750131948179195
IQ在85-115之间的概率: 0.6826894921370859
样本均值: 99.87
样本标准差: 14.52
```
...
**原理**: $P(X=k) = \frac{\lambda^k e^{-\lambda}}{k!}$，其中λ是平均发生率
