...
def demo_line_plot():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/pandas_line_plot.png', dpi=100)
    plt.close()
    print("折线图已保存到 outputs/pandas_line_plot.png")
...
def demo_bar_plot():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/pandas_bar_plot.png', dpi=100)
    plt.close()
    print("柱状图已保存")
...
def demo_histogram():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/pandas_histogram.png', dpi=100)
    plt.close()
    print("直方图已保存")
...
def demo_scatter():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/pandas_scatter.png', dpi=100)
    plt.close()
    print("散点图已保存")
...
def demo_boxplot():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/pandas_boxplot.png', dpi=100)
    plt.close()
    print("箱线图已保存")
...
def demo_pie():
    ...
    ax.set_ylabel('')
    plt.tight_layout()
    plt.savefig('../outputs/pandas_pie.png', dpi=100)
    plt.close()
    print("饼图已保存")
