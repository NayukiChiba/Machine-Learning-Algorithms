...
def demo_figure_axes():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/viz_01_basic.png', dpi=100)
    plt.close()
    print("图表已保存到 outputs/viz_01_basic.png")
...
def demo_line_styles():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/viz_01_line_styles.png', dpi=100)
    plt.close()
    print("图表已保存")
...
def demo_markers():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/viz_01_markers.png', dpi=100)
    plt.close()
    print("图表已保存")
...
def demo_subplots():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/viz_01_subplots.png', dpi=100)
    plt.close()
    print("图表已保存")
