...
def demo_bar():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/viz_02_bar.png', dpi=100)
    plt.close()
    print("图表已保存")
...
def demo_scatter():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/viz_02_scatter.png', dpi=100)
    plt.close()
    print("图表已保存")
...
def demo_histogram():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/viz_02_histogram.png', dpi=100)
    plt.close()
    print("图表已保存")
...
def demo_pie():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/viz_02_pie.png', dpi=100)
    plt.close()
    print("图表已保存")
...
def demo_boxplot():
    ...
    plt.tight_layout()
    plt.savefig('../outputs/viz_02_boxplot.png', dpi=100)
    plt.close()
    print("图表已保存")
