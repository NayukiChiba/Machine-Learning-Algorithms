...
@print_func_info
def generate_data(n_samples:int=200, noise:int=10, random_state:int=42) -> DataFrame:
    '''
    生成模拟数据
    ...
    '''
    price = 2*area + 10*num - 3*age + np.random.normal(loc=0, scale=noise, size=n_samples) + 50
