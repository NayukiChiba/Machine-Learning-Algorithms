"""
model_training/regression/decision_tree.py
决策树回归模型训练
...
或直接运行:
    python -m model_training.regression.decision_tree
"""
...
if __name__ == "__main__":
    ...
    X = decision_tree_regression_data.drop(columns=["price"])
    y = decision_tree_regression_data["price"]
